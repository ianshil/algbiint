...
- intros. simpl. destruct (eq_dec_form A a).
  ...
  * simpl. apply Arith_base.lt_n_S_stt. apply IHl. inversion H. subst. exfalso. apply n. auto.
    assumption.
Qed.
...
- intros. simpl. destruct (eq_dec_form A a).
  ...
  * inversion H0.
    ...
    + assert (a :: l2 = [a] ++ l2). auto. rewrite H2. rewrite remove_list_dist_app.
      ...
      rewrite H3. simpl. apply Arith_base.lt_n_S_stt. apply IHl2 with (A:=A) ; assumption.
Qed.
...
- intro l2. split.
  ...
  * intros. simpl. destruct l2 as [ | b l2].
    + reflexivity.
...
- intros. destruct (In_dec l1 a).
  ...
  * rewrite keep_list_delete_head_not_In. 2: assumption. assert (In a l3). apply H1.
    ...
    rewrite keep_list_delete_head_not_origin. 2 : assumption. apply Arith_base.lt_n_S_stt.
...
Proof.
induction l1.
- intros. destruct H. destruct l2 as [ | b l2] ; auto. unfold incl in H0. pose (H0 b). assert (In b (b :: l2)).
